...
2. Restate the landfall's purpose and stop conditions in one sentence.
...
5. Update the listed write targets when evidence is strong:
   - task list
   - evidence files
   - payables
   - wiki summaries
   - calendar notes
6. If evidence is weak, record the uncertainty instead of closing the task.
